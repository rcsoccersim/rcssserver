...
#ifndef _LANDMARKREADER_H_
#define _LANDMARKREADER_H_
...
private:
  ...
  struct flag_t
  {
    ...
    flag_t( double xval, double yval, const std::string& flagname,
            double flagver )
      : x( xval ),
        y( yval ),
        name( flagname ),
    ...
    std::ostream& toXml ( std::ostream& o , bool x_per = true, bool y_per = true ) const
    {
